...
// here we make the screens for the auth flow.
// notice all the UI components Doorman exports, like Page and ScreenBackground, even while not on the auth screens! :)
...
export const Splash = () => {
	...
	return (
		<Page style={styles.page} background={() => <ScreenBackground />}>
			<H1
				style={styles.text}
			>{`Welcome to Doorman's React Navigation v5 test app`}</H1>
			<Paragraph
				style={styles.text}
